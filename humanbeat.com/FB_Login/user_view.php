...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">
    <img src="<?php echo $_SESSION['userData']['picture']['url']?>" class="w3-circle" style="height:23px;width:23px" alt="Avatar">
  </a>
 </div>
</div>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         <h4 class="w3-center">
        <?php if(!isset($_SESSION['userData']['name'])):
          header("location:../auth/redirected_page.php");?>
         <?php else: ?>
         <p><?php if(isset($_SESSION['userData']['name'])) echo $_SESSION['userData']['first_name']."\r\n"; echo $_SESSION['userData']['last_name'];?> <br><a href="../auth/logout.php">Logout</a></p>
         <?php endif ?></h4>
         <p class="w3-center"><img src="<?php echo $_SESSION['userData']['picture']['url']?>" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> <?php $str=$_SESSION['userData']['gender']; echo $str = ucfirst($str);;?></p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Dhaka, Bangladesh</p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> 6 October , 1994 </p>
        </div>
      </div>
      <br>
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
         ...
         <br>
           ...
           <div class="w3-half">
             <img src="http://www.w3schools.com/w3images/snow.jpg" style="width:100%" class="w3-margin-bottom">
           </div>
         </div>
          </div>
        </div>
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        <img src="http://www.w3schools.com/w3images/avatar5.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        <img src="http://www.w3schools.com/w3images/avatar6.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
