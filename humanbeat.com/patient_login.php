...
<body data-vide-bg="images/login_bg">
<section class="login-maintop">
	<div class="login-main">
		<header><h1>Patient login form</h1></header>
		<div class="login-form">
			<h2>login now</h2>
			<form action="#" method="get">
				<span><i class="fa fa-unlock-alt" aria-hidden="true"></i></span>
				<input type="text" name="username" placeholder="enter your name or mobile number" required="">
				<span><i class="fa fa-unlock-alt" aria-hidden="true"></i></span>
